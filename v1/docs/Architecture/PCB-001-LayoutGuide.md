...
1. Open the `MeetingHub-4-v1.kicad_pro` project in KiCad.
2. Open the **PCB Editor** (board icon, or double-click
   `MeetingHub-4-v1.kicad_pcb` in the project tree).
...
- **Final BOM** - we already have one generated at
  `hardware/BOM/BOM-MeetingHub-4-v1.csv`; confirm it still matches the final
