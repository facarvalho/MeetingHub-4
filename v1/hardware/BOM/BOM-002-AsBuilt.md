...
Raw file: [BOM-MeetingHub-4-v1.csv](BOM-MeetingHub-4-v1.csv)
...
dropped during the reroute. See gerbers v13.0 and BOM-PCBA-MeetingHub-4-v1.csv
item 8 for detail.
...
v11.0 and BOM-PCBA-MeetingHub-4-v1.csv item 9 for detail.
