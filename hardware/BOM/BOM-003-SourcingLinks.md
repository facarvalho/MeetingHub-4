...
| Micro chave tátil SPST THT ângulo reto, com braçadeira (SHOU HAN TS665ZJ) — montagem horizontal, painel frontal — peça única para MUTE + 4 seletoras, substitui Omron B3F-4005 (SW1) e CW Industries GPTS203211B (SW2-SW5, antes sem estoque/consignada) | SW1, SW2, SW3, SW4, SW5 | LCSC C557599 | https://www.lcsc.com/product-detail/C557599.html | 5 |
...
| Capa/botão para SW1 (mute) e SW2-SW5 (seletoras) — **opcional**: o próprio TS665ZJ (C557599) já vem com sua capa preta integrada (item "帽头" no desenho do fabricante, plástico PPA preto, Ø3.5mm redondo) — só comprar um acabamento à parte se quiser um botão maior/mais bonito que a capa de fábrica pequena. Buscar "6x6mm tactile switch cap round black" na LCSC/AliExpress | SW1-SW5 | — | — | 5 (se optar por trocar) |
